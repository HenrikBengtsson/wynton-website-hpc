...
```sh
[alice@{{< meta devel.name >}} ~]$ python3 -m pip install --user pandas
Collecting pandas
...
```sh
[alice@{{< meta devel.name >}} ~]$ python3 -m pip install --user virtualenv
...
[alice@{{< meta devel.name >}} ~]$ which virtualenv
~/.local/bin/virtualenv
[alice@{{< meta devel.name >}} ~]$ virtualenv --version
...
```sh
[alice@{{< meta devel.name >}} ~]$ virtualenv -p python3 my_project
...
```sh
[alice@{{< meta devel.name >}} ~]$ cd my_project
[alice@{{< meta devel.name >}} my_project]$ . bin/activate   ## IMPORTANT! Note period in front
(my_project) [alice@{{< meta devel.name >}} my_project]$ 
```
...
```sh
(my_project) [alice@{{< meta devel.name >}} my_project]$ which python3
...
```sh
(my_project) [alice@{{< meta devel.name >}} my_project]$ which python
~/my_project/bin/python
(my_project) [alice@{{< meta devel.name >}} my_project]$ python --version
Python 3.11.10
```
...
```sh
(my_project) [alice@{{< meta devel.name >}} my_project]$ python3 -m pip list
Package         Version
--------------- -----------
numpy           2.2.0
pandas          2.2.3
...
```sh
(my_project) [alice@{{< meta devel.name >}} ~]$ python3 -m pip install pandas
...
```sh
[alice@{{< meta devel.name >}} ~]$ cd my_project 
[alice@{{< meta devel.name >}} my_project]$ . bin/activate   ## ACTIVATE
(my_project) [alice@{{< meta devel.name >}} my_project]$ pip3 show pandas
Name: pandas
Version: 2.2.3
...
```sh
(my_project) [alice@{{< meta devel.name >}} ~]$ deactivate
...
```sh
[alice@{{< meta devel.name >}} ~]$ which python3
/usr/bin/python3
```
...
```sh
[alice@{{< meta devel.name >}} ~]$ python3 -m pip install --user --upgrade pip
...
```sh
[alice@{{< meta devel.name >}} ~]$ python3 -m pip install --upgrade pip
```
...
```sh
[alice@{{< meta devel.name >}} ~]$ python3 -m pip --version
...
```sh
[alice@{{< meta devel.name >}} ~]$ python2 -m pip install --user --upgrade "pip<21"
