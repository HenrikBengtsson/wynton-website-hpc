...
MATLAB is available on {{< meta cluster.name >}} via a [built-in environment module] and is supported by a UCSF-wide MATLAB license.
...
[built-in environment module]: /hpc/software/software-repositories.html
[specify the number of CPU cores]: /hpc/scheduler/submit-jobs.html
