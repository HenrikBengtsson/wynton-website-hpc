...
<!--
```
r_path='/wynton/home/cbi/shared/software/_rocky8/R-4.5.2-gcc13'
r_libs_user_path='/wynton/home/boblab/alice/R/rocky8-x86_64-pc-linux-gnu-library/4.5-CBI-gcc13'
```
-->
...
1. Your personal R package library. This is located under `~/R/`,
   e.g. `~/R/rocky8-x86_64-pc-linux-gnu-library/{{
   r_libs_user }}/`
