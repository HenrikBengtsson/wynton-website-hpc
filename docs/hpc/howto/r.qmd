...
r:
  linux_distro: "rocky8"
  basename: "R-4.5.2-gcc13"
  libs_user: "4.5-CBI-gcc13"
  path: "/wynton/home/cbi/shared/software/_rocky8/R-4.5.2-gcc13"
  libs_user_path: "/wynton/home/boblab/alice/R/rocky8-x86_64-pc-linux-gnu-library/4.5-CBI-gcc13"
format: html
---

# Work with R

R is available on {{< meta cluster.name >}} via a [contributed environment module].
...
```sh
[alice@{{< meta devel.name >}} ~]$ module load CBI
[alice@{{< meta devel.name >}} ~]$ module load r
```
...
```sh
[alice@{{< meta devel.name >}} ~]$ module load CBI
[alice@{{< meta devel.name >}} ~]$ module load r/3.5.3
```
...
1. Your personal R package library. This is located under `~/R/`,
   e.g. `~/R/{{< meta r.linux_distro >}}-x86_64-pc-linux-gnu-library/{{< meta r.libs_user >}}/`

2. (optional) A site-wide R package library (not used on {{< meta cluster.name >}})

3. The system-wide R package library part of the R installed, e.g. `{{< meta r.path >}}/lib64/R/library`
...
Warning in install.packages("zoo") :
  'lib = "{{< meta r.path >}}/lib64/R/library"' is not writable
...
'~/R/{{< meta r.linux_distro >}}-x86_64-pc-linux-gnu-library/{{< meta r.libs_user >}}'
...
```r
Would you like to create a personal library
'~/R/x86_64-pc-linux-gnu-library/{{< meta r.libs_user >}}'
...
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I../inst/include  -I/usr/local/include    -fpic  -g -O2  -c coredata.c -o coredata.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I../inst/include  -I/usr/local/include    -fpic  -g -O2  -c init.c -o init.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I../inst/include  -I/usr/local/include    -fpic  -g -O2  -c lag.c -o lag.o
gcc -std=gnu2x -shared -L{{< meta r.path >}}/lib64/R/lib -L/usr/local/lib64 -o zoo.so coredata.o init.o lag.o -L{{< meta r.path >}}/lib64/R/lib -lR
installing to {{< meta r.libs_user_path >}}/00LOCK-zoo/00new/zoo/libs
** R
** demo
** inst
...
Installing package into '{{< meta r.libs_user_path >}}'
...
** libs
using C compiler: ‘gcc (GCC) 13.3.1 20240611 (Red Hat 13.3.1-2)’
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG   -I/usr/local/include    -fpic  -g -O2  -c init.c -o init.o                                                                                          
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG   -I/usr/local/include    -fpic  -g -O2  -c normexp.c -o normexp.o                                                                                    
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG   -I/usr/local/include    -fpic  -g -O2  -c weighted_lowess.c -o weighted_lowess.o                                                                    
gcc -std=gnu2x -shared -L{{< meta r.path >}}/lib64/R/lib -L/usr/local/lib64 -o limma.so init.o normexp.o weighted_lowess.o -L{{< meta r.path >}}/lib64/R/lib -lR               
installing to {{< meta r.libs_user_path >}}/00LOCK-limma/00new/limma/libs
** R
** inst
** byte-compile and prepare package for lazy loading
** help
...
```sh
[alice@{{< meta devel.name >}} ~]$ module load mpi/openmpi-x86_64
[alice@{{< meta devel.name >}} ~]$ module list
...
```r
[alice@{{< meta devel.name >}} ~]$ module load CBI r
[alice@{{< meta devel.name >}} ~]$ module load mpi/openmpi-x86_64
[alice@{{< meta devel.name >}} ~]$ R
...
> library(Rmpi)
...
master (rank 0, comm 1) of size 2 is running on: {{< meta devel.name >}} 
slave1 (rank 1, comm 1) of size 2 is running on: {{< meta devel.name >}}
...
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c comm_errors.c -o comm_errors.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c comm_sort_double.c -o comm_sort_double.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c comm_sort_integer.c -o comm_sort_integer.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c pkg_dl.c -o pkg_dl.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c pkg_tools.c -o pkg_tools.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd.c -o spmd.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_allgather.c -o spmd_allgather.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_allgatherv.c -o spmd_allgatherv.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_allreduce.c -o spmd_allreduce.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_alltoall.c -o spmd_alltoall.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_alltoallv.c -o spmd_alltoallv.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_bcast.c -o spmd_bcast.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_communicator.c -o spmd_communicator.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_communicator_spawn.c -o spmd_communicator_spawn.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_gather.c -o spmd_gather.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_gatherv.c -o spmd_gatherv.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_info.c -o spmd_info.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_recv.c -o spmd_recv.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_reduce.c -o spmd_reduce.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_scatter.c -o spmd_scatter.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_scatterv.c -o spmd_scatterv.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_send.c -o spmd_send.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_sendrecv.c -o spmd_sendrecv.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_sendrecv_replace.c -o spmd_sendrecv_replace.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_tool.c -o spmd_tool.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_utility.c -o spmd_utility.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c spmd_wait.c -o spmd_wait.o
gcc -std=gnu2x -I"{{< meta r.path >}}/lib64/R/include" -DNDEBUG -I/usr/include/openmpi-x86_64  -DMPI2 -DOPENMPI  -I/usr/local/include    -fpic  -g -O2  -c zzz.c -o zzz.o
gcc -std=gnu2x -shared -L{{< meta r.path >}}/lib64/R/lib -L/usr/local/lib64 -o pbdMPI.so comm_errors.o comm_sort_double.o comm_sort_integer.o pkg_dl.o pkg_tools.o spmd.o spmd_allgather.o spmd_allgatherv.o spmd_allreduce.o spmd_alltoall.o spmd_alltoallv.o spmd_bcast.o spmd_communicator.o spmd_communicator_spawn.o spmd_gather.o spmd_gatherv.o spmd_info.o spmd_recv.o spmd_reduce.o spmd_scatter.o spmd_scatterv.o spmd_send.o spmd_sendrecv.o spmd_sendrecv_replace.o spmd_tool.o spmd_utility.o spmd_wait.o zzz.o -L/usr/lib64/openmpi/lib -lmpi -lutil -lpthread -L{{< meta r.path >}}/lib64/R/lib -lR
installing via 'install.libs.R' to {{< meta r.libs_user_path >}}/00LOCK-pbdMPI/00new/pbdMPI
** R
** demo
** inst
** byte-compile and prepare package for lazy loading
...
support) will be disabled for this port.
  ...
  Local host:           {{< meta devel.name >}}
  Local device:         mlx5_0
  Local port:           1
  CPCs attempted:       rdmacm, udcm
--------------------------------------------------------------------------
[1684168833.604597] [{{< meta devel.name >}}:227206:0]       ib_iface.c:700  UCX  ERROR ibv_create_cq(cqe=4096) failed: Cannot allocate memory
[{{< meta devel.hostname >}}:227206] pml_ucx.c:208 Error: Failed to create UCP worker
** checking absolute paths in shared objects and dynamic libraries
** testing if installed package can be loaded from final location
--------------------------------------------------------------------------
No OpenFabrics connection schemes reported that they were able to be
...
support) will be disabled for this port.
  ...
  CPCs attempted:       rdmacm, udcm
--------------------------------------------------------------------------
[1684168836.256287] [{{< meta devel.name >}}:227248:0]       ib_iface.c:700  UCX  ERROR ibv_create_cq(cqe=4096) failed: Cannot allocate memory
[{{< meta devel.hostname >}}:227248] pml_ucx.c:208 Error: Failed to create UCP worker
** testing if installed package keeps a record of temporary installation path
* DONE (pbdMPI)
...
* removing '{{< meta r.libs_user_path >}}/rjags'
ERROR: dependency 'rjags' is not available for package 'infercnv'
* removing '{{< meta r.libs_user_path >}}/infercnv'
```
...
[contributed environment module]: /hpc/software/software-repositories.html
