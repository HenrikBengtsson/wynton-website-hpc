...
### Set up a Globus Collection for your {{< meta cluster.nickname >}} account

If you want to transfer files from or to your {{< meta cluster.nickname >}} account, you need to set up the '{{< meta globus.name >}}' Collection.  Below is an outline on how to do this.
...
3. Then locate the ['{{< meta globus.name >}}' collection]. 
4. This will bring up the "Overview" of the ['{{< meta globus.name >}}' collection]. 
...
8. Enter your {{< meta cluster.nickname >}} credential, i.e. your {{< meta cluster.nickname >}} username and password. 
...
* **If step 4/5 above fails and you receive a message similar to "Identity set contains identity from an allowed domain but it does not map to a valid username for this connector." contact [{{< meta cluster.email_support >}}](mailto::{{< meta cluster.email_support >}}).**
...
* ['{{< meta globus.name >}}' Collection] (UUID `{{< meta globus.uuid >}}`)
* ['{{< meta globus-protected.name >}}' Collection] (UUID `{{< meta globus-protected.uuid >}}`)
...
['{{< meta globus.name >}}' Collection]: https://app.globus.org/file-manager/collections/{{< meta globus.uuid >}}/overview
['{{< meta globus-protected.name >}}' Collection]: https://app.globus.org/file-manager/collections/{{< meta globus-protected.uuid >}}/overview
