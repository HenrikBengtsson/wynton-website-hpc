...
**Notice**: All of the {{< meta cluster.name >}} environment is down for maintenance
and upgrades.
...
**Resolved**: The {{< meta cluster.name >}} system is considered fully functional again.  The legacy, deprecated NetApp storage was lost.
