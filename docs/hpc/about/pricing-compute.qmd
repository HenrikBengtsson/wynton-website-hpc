...
To purchase compute nodes or GPU nodes, please contact [{{< meta cluster.email_compute >}}](mailto:{{< meta cluster.email_compute >}}?subject=Request%20to%20purchase%20compute). Please include what you are considering contributing and your UCSF COA [SpeedType] or [chartstring] for billing, along with any questions.

If you are not ready to purchase but have technical questions while you explore options, please contact {{< meta cluster.email_support >}}. 
