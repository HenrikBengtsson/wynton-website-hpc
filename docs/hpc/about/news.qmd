...
2020-02-26: Website moved to <{{< meta organization.url >}}/hpc/>.
...
2019-04-12: Migrated another [24 nodes (396 cores)](/hpc/about/specs.html) from QB3 to {{< meta cluster.name >}}.
...
2019-03-17: The majority (136 nodes; 3680 cores) of the QB3 nodes has now been migrated to {{< meta cluster.name >}}.

2019-03-15: Migrated another [8 nodes (224 cores)](/hpc/about/specs.html) from QB3 to {{< meta cluster.name >}}.

2019-03-12: Migrated another [19 nodes (532 cores)](/hpc/about/specs.html) from QB3 to {{< meta cluster.name >}}.

2019-03-08: Migrated another [10 nodes (264 cores)](/hpc/about/specs.html) from QB3 to {{< meta cluster.name >}}.

2019-03-07: Migrated another [11 nodes (292 cores)](/hpc/about/specs.html) from QB3 to {{< meta cluster.name >}}.

2019-03-06: Migrated another [15 nodes (392 cores)](/hpc/about/specs.html) from QB3 to {{< meta cluster.name >}}.

2019-03-05: Migrated another [15 nodes (392 cores)](/hpc/about/specs.html) from QB3 to {{< meta cluster.name >}}.

2019-03-01: Migrated [48 nodes (1344 cores)](/hpc/about/specs.html) from QB3 to {{< meta cluster.name >}}.
...
2018-08-02: Added a dedicate [10 Gbps transfer node](/hpc/about/specs.html#data-transfer-nodes) for faster file transfers in to and out from {{< meta cluster.nickname >}}.
...
2017-09-07: {{< meta cluster.name >}} is live.
