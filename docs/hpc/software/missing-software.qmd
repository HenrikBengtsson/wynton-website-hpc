...
1. [Install it yourself](/hpc/howto/install-from-source.html) to your own account
...
3. Reach out to the [{{< meta cluster.name >}} user community](/hpc/support/index.html)
