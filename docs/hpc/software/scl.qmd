...
```sh
[alice@{{< meta devel.name >}} ~]$ scl list-collections
gcc-toolset-10
gcc-toolset-11
gcc-toolset-12
gcc-toolset-13
...
```sh
[alice@{{< meta devel.name >}} ~]$ scl list-packages gcc-toolset-11
...
```sh
[alice@{{< meta devel.name >}} ~]$ scl enable gcc-toolset-12 "gcc --version"
...
```sh
[alice@{{< meta devel.name >}} ~]$ scl enable gcc-toolset-12 "$SHELL"
...
```sh
[alice@{{< meta devel.name >}} ~]$ module unload CBI scl-gcc-toolset/12
[alice@{{< meta devel.name >}} ~]$ gcc --version
